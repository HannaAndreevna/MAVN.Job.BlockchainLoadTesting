...
namespace Lykke.Job.BlockchainLoadTesting
{
    ...
    public class Startup
    {
        ...
        {
            ApiTitle = "BlockchainLoadTestingJob API",
            ApiVersion = "v1"
        };
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "BlockchainLoadTestingJobLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.BlockchainLoadTestingJob.Db.LogsConnString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("BlockchainLoadTesting", channelOptions =>
                        {
